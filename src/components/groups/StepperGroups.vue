            ...
            "
                ...
                <div class="row items-center">
                  ...
                  '#277da1'
                            ...
                            class="my-picker" />
                        <span class="text-caption text-weight-light">Pick group color</span>
                    </div>
                ...
                <q-form
                    ...
                    <div class="row justify-between q-mb-md">
                        <q-input
                            ...
                            <q-tooltip>Type in the date YYYY/MM/DD or click on the icon</q-tooltip>
                        </q-input>
                        <q-input
                            type="number"
                            outlined
                  ...
                  val => val > 0 || 'Group cannot be shorter then a week'
                    ...
                    <div class="row justify-center q-mt-xl">
                        <span class="text-body1 text-weight-light text-justify">If group meets regularly select days of the week and lessons
                  ...
                  " />
                    ...
                    <q-slide-transition>
                        <q-card
                            class="q-my-lg"
                            v-show="activeDays.length > 0">
                            <q-card-section>
                                <div class="row justify-center">
                                    <span class="text-body1 text-weight-light">Click on the tabs to set time and duration of the
                                        lesson</span>
                                </div>
                            </q-card-section>
                            <q-tabs
